...
#cv2.imwrite("sobelcombined.png", sobelcombined)
#cv2.imwrite("sobelx.png", sobelx)
#cv2.imwrite("sobely.png", sobely)
#cv2.imwrite("laplace.png",lap)
...
#cv2.imwrite("output.jpg", lap)

hist = cv2.calcHist([sobelcombined], [0], None, [256], [0, 256])
plt.figure()
plt.title("Sobel - xy Histogram")
plt.xlabel("Bins")
