...
img = cv2.pyrDown(cv2.imread('mask41.jpg', cv2.IMREAD_UNCHANGED))
img1 = cv2.pyrDown(cv2.imread('frame41.jpg', cv2.IMREAD_UNCHANGED))
elippic = img.copy()
elipic = img1.copy()
#elipic1 = img1.copy()
...
image, contours, hier = cv2.findContours(img, cv2.RETR_EXTERNAL,
